...
object CardUtils {
    ...
    fun getCampResIdList(camp: String): List<Int> {
        val campResIdList = camp
                ...
                .toTypedArray()
                .mapTo(ArrayList<Int>()) { MapConst.CampMap.getOrDefault(it, -1) }
    ...
    fun getImagePathList(imageJson: String): List<String> {
        return JsonUtils.deserializerArray(imageJson, Array<String>::class.java)?.map { image -> pictureCache + image } as List<String>
    }
